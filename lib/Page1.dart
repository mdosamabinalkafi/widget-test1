                    ...
                    child: Padding(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: NetworkImage(
                          "https://avatars.githubusercontent.com/u/175422146?v=4",
                        ),
                      ),
                    ),
                  ),
        ...
        children: [
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20),
                  Text(
                    'উপরের নীল বারটাই AppBar। এতে title, leading icon, action icons থাকে।',
                  ),
                  SizedBox(height: 20),
                  Row(
                    children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ListTile(title: Text('ListTile'), leading: Icon(Icons.list)),

                  SizedBox(height: 20),
                  Text(
                    'List এর একটা row। Leading icon, title, subtitle, trailing থাকে।',
                  ),
                  SizedBox(height: 20),
